...
class _EditState extends State<Edit> {
 ...
 Future<void> downloadFile() async {
  ...
  var filePath = "${directory.path}/${widget.emploiyer.photo}";
  var response = await http.get(Uri.parse('http://192.168.47.112:8000'+widget.emploiyer.photo));
  var _pickedImage = File(filePath);
  await _pickedImage.writeAsBytes(response.bodyBytes);
}
      ...
      Container( 
                  ...
                  child: ElevatedButton.icon(
                      onPressed: (){
                       ...
                       EmploiyerController.editEmploiye(emploiyeEdit,_pickedImage).then((yt) {
